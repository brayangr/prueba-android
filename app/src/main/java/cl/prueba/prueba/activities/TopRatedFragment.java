...
public class TopRatedFragment extends Fragment implements Callback<Movies> {
    ...
    public void loadData() {
        ...
        Call<Movies> call = theMovieDbAPI.getTopRated("34738023d27013e6d1b995443764da44");
        call.enqueue(this);
    ...
    public void onResponse(Call<Movies> call, Response<Movies> response) {
        if(response.isSuccessful()) {
            ...
            ListView list = this.getView().findViewById(R.id.top_rated_list_view);
